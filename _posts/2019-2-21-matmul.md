...
![Block size on performance]({{ "res/img/Block size on performance.png" | absulute_url }})
...
![block size on performance with AVX and loop unrolling]({{ "res/img/Block size on performance with AVX and loop unrolling.png" | absulute_url }})
\pagebreak
...
![Unroll size on performance with AVX and blocking]({{ "res/img/Unroll size on performance with AVX and blocking.png" | absulute_url }})
...
![ICC vs GCC]({{ "res/img/Choice of compilers and size v performance.png" | absulute_url }})
...
![O2 GCC v ICC]({{ "res/img/O2 Optimize Option GCC v ICC.png" | absulute_url }})
...
![O3 GCC v ICC]({{ "res/img/O3 Optimize Option GCC v ICC.png" | absulute_url }})
...
![O2 v O3]({{ "res/img/Optimize Option -O2 v -O3 with GCC.png" | absulute_url }})
...
![O2 v O3 v Ofast]({{ "res/img/Optimize Option -O2 v -O3 v -Ofast with GCC.png" | absulute_url }})
...
![Final results]({{ "res/img/Final vs naive blocking performance.png" | absulute_url }})
...
Both Daniel and I (Rustie) did everything together as that was the best way each of us learned -- especially since our group only had two people. We would research our own things, branch out, and then join back together for implementation and testing and discussion of results. The writeup was also done jointly. As for focuses, I focused more on blocking and unrolling and AVX, whereas Daniel focused more on compiler options and transpose. -- Rustie
